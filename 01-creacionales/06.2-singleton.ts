...
class DatabaseConnection {
  ...
  public static getInstance(): DatabaseConnection {
    ...
    if (!DatabaseConnection.instance) {
      ...
      console.log("%cInstance created", COLORS.blue);
    }
  ...
  public connect(): void {
    ...
    if (this.connected) {
      console.log("%cThere is an active connection", COLORS.red);
      return;
    }

    this.connected = true;
    console.log("%cConnection established", COLORS.green);
  }
  ...
  public disconnect(): void {
    ...
    if (this.connected) {
      ...
      console.log("%cConnection terminated", COLORS.yellow);
      return;
    }

    console.log("%cThere is no active connection", COLORS.red);
  }
}
